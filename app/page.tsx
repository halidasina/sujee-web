...
export default function Home() {
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: '#fdf8f0' }}>
      ...
      {/* NAV */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#fdf8f0]/90 backdrop-blur-sm border-b border-[#c8973a]/20">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[85vh]">
            ...
            <div className="order-2 md:order-1">
              <span className="inline-block text-xs uppercase tracking-widest text-[#c8973a] font-sans mb-4 border border-[#c8973a]/40 px-3 py-1 rounded-full">
                Kek Tradisional Premium · Molife Delights
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-[#5c3d2e] leading-tight mb-6">
                Kek Suji Klasik<br />
                <span className="text-[#c8973a]">Yang Berbeza</span>
              </h1>
              <p className="text-[#5c3d2e]/70 font-sans text-lg leading-relaxed mb-8">
              ...
              <div className="flex gap-8">
                <div>
                  <p className="text-2xl font-serif text-[#c8973a] font-bold">100%</p>
                  <p className="text-xs font-sans text-[#5c3d2e]/60 uppercase tracking-wide">Butter Premium</p>
                </div>
                <div className="border-l border-[#c8973a]/20 pl-8">
                  <p className="text-2xl font-serif text-[#c8973a] font-bold">2 tbsp</p>
                  <p className="text-xs font-sans text-[#5c3d2e]/60 uppercase tracking-wide">Tepung Gandum Sahaja</p>
                </div>
                <div className="border-l border-[#c8973a]/20 pl-8">
                  <p className="text-2xl font-serif text-[#c8973a] font-bold">Suji+</p>
                  <p className="text-xs font-sans text-[#5c3d2e]/60 uppercase tracking-wide">Tepung Almond</p>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 md:order-2 relative">
              <div className="relative aspect-square max-w-md mx-auto">
                <div className="absolute inset-0 bg-[#c8973a]/10 rounded-3xl rotate-3" />
                ...
                {/* Floating badge */}
                <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-lg px-5 py-3 border border-[#c8973a]/20">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {usps.map((usp) => (
              <div
                key={usp.title}
                className="text-center p-8 rounded-2xl border border-[#c8973a]/20 hover:border-[#c8973a]/50 hover:shadow-md transition-all duration-200"
              >
          ...
          <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
            {products.map((product) => {
              ...
              return (
                <div
                  key={product.id}
                  className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 border border-[#c8973a]/10"
                >
            ...
            <div>
              ...
              <ol className="space-y-2 font-sans text-sm text-white/70">
                <li className="flex gap-2">
                  <span className="text-[#c8973a] font-bold">1.</span>
                  Pilih saiz kek (450gm / 1kg)
                </li>
                <li className="flex gap-2">
                  <span className="text-[#c8973a] font-bold">2.</span>
                  Check delivery fee di atas
                </li>
                <li className="flex gap-2">
                  <span className="text-[#c8973a] font-bold">3.</span>
                  Klik Order via WhatsApp
                </li>
                <li className="flex gap-2">
                  <span className="text-[#c8973a] font-bold">4.</span>
