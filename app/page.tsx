        ...
        <div className="max-w-2xl mx-auto px-6">
          ...
          <FadeIn>
            <div className="bg-[#fdf8f0] rounded-2xl p-8 shadow-sm border border-[#c8973a]/20">
              ...
              />
              <p className="text-xs font-sans text-[#5c3d2e]/50 mt-1 mb-5">
                Penghantaran via Lalamove — KL & Selangor sahaja
              </p>

              {/* WA Button */}
              <motion.a
                whileHover={{ scale: address.trim() ? 1.02 : 1 }}
                whileTap={{ scale: address.trim() ? 0.98 : 1 }}
                href={formFilled ? waUrl(waMsg) : undefined}
                target="_blank"
              ...
              >
                ...
                {formFilled ? 'Hantar Order via WhatsApp' : 'Isi semua maklumat dahulu'}
              </motion.a>
            ...
            <FadeIn delay={0.1}>
              ...
              <div className="space-y-3">
                <motion.button
                  whileHover={{ x: 4 }}
                  onClick={() => scrollToOrder()}
                  className="flex items-center gap-3 font-sans text-sm text-white/70 hover:text-white transition-colors cursor-pointer"
                >
